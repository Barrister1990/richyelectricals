          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div>
              ...
              <p className="text-orange-100">
                Get a free quote today and experience our expert service.
              </p>
            </div>
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="/contact"
                className="inline-block bg-white text-orange-600 font-semibold py-3 px-6 rounded-lg shadow-md hover:bg-gray-50 transition-colors duration-300"
              >
                Contact Us Now
              </Link>
            </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.tiktok.com/@richy_electric?_t=ZN-8vbqj7KYN4o&_r=1"
                className="bg-gray-800 hover:bg-orange-500 h-10 w-10 rounded-full flex items-center justify-center transition-colors duration-300"
              >
                <Music size={18} />
              ...
              <a
                href="https://www.instagram.com/richyelectricalservices?igsh=Z2I5eXdoMWgwNHAw&utm_source=qr"
                className="bg-gray-800 hover:bg-orange-500 h-10 w-10 rounded-full flex items-center justify-center transition-colors duration-300"
              >
                <Instagram size={18} />
